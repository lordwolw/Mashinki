...
//  Mashinki
//
//  Created by Никита Кичкаев on 16.12.2021.
//
...
class ChangeCarCollectionViewController: UICollectionViewController {
    ...
    func viewDidLoad(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return cars.count
